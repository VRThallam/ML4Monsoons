...
dataset = loadtxt('feb_025_train_all_param.csv', delimiter=',', skiprows=1)
X = dataset[:, :36]
...
np.savetxt("ensemble_optuna_feb_0.25_predictions.csv", ensemble_preds_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_feb_0.25_uncertainty.csv", ensemble_std_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_feb_0.25_true_values.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('optuna_ensemble_feb_0.25_val_loss_comparison.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_feb_0.25_true_vs_predicted.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_feb_0.25_residuals_plot.pdf')
plt.show()