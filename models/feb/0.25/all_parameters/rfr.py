...
# Load dataset
dataset = np.loadtxt('/content/feb_025_train_all_param.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# Save predictions
np.savetxt("feb_rf_predictions.csv", predictions, delimiter=",")
np.savetxt("feb_rf_y_test.csv", y_test_orig, delimiter=",")
...
plt.savefig("feb_rf_prediction_vs_true.pdf")
plt.show()
...
plt.savefig("feb_rf_feature_importance.pdf")
plt.show()
