...
# Load dataset
dataset = np.loadtxt('C:\\feb_025_train_only_prec.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:14]
...
# Save best model
joblib.dump(random_search.best_estimator_, 'rf_randomized_best_model_feb_025_only_prec.pkl')
...
# Save predictions
np.savetxt("rf_feb_025_only_prec_predictions.csv", predictions, delimiter=",")
np.savetxt("rf_feb_025_only_prec_y_test.csv", y_test_orig, delimiter=",")
...
plt.savefig("rf_feb_025_only_prec_prediction_vs_true.pdf")
plt.show()
...
plt.savefig("rf_feb_025_only_prec_feature_importance.pdf")
plt.show()
