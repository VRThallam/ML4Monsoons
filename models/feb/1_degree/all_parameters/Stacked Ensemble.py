...
# ========== Save Predictions ==========
np.savetxt("predictions/stacked_ensemble_feb_1_predictions.csv", meta_pred, delimiter=",")
np.savetxt("predictions/y_test_actual_feb_1.csv", y_test_orig, delimiter=",")
np.savetxt("predictions/quantile_feb_1_q10.csv", q10_inv, delimiter=",")
np.savetxt("predictions/quantile_feb_1_q50.csv", q50_inv, delimiter=",")
np.savetxt("predictions/quantile_feb_1_q90.csv", q90_inv, delimiter=",")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/stacked_ensemble_feb_1_predictions.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/quantile_feb_1_prediction_bands_stacked.pdf")
plt.show()
