...
np.savetxt("ensemble_optuna_feb_1_predictions.csv", ensemble_preds_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_feb_1_uncertainty.csv", ensemble_std_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_feb_1_true_values.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('optuna_ensemble_feb_1_val_loss_comparison.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_feb_1_true_vs_predicted.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_feb_1_residuals_plot.pdf')
plt.show()
