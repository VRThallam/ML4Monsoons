...
dataset = loadtxt('/content/jan_025_train.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# ========== Save Predictions ==========
np.savetxt("predictions/stacked_ensemble_jan_025_predictions.csv", meta_pred, delimiter=",")
np.savetxt("predictions/y_test_actual_jan_025.csv", y_test_orig, delimiter=",")
np.savetxt("predictions/quantile_jan_025_q10.csv", q10_inv, delimiter=",")
np.savetxt("predictions/quantile_jan_025_q50.csv", q50_inv, delimiter=",")
np.savetxt("predictions/quantile_jan_025_q90.csv", q90_inv, delimiter=",")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/stacked_ensemble_jan_025_predictions.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/quantile_jan_025_prediction_bands_stacked.pdf")
plt.show()