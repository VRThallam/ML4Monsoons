...
dataset = np.genfromtxt("/content/jan_025_train.csv", delimiter=',', skip_header=1)
X = dataset[:, :36]
...
#mc = ModelCheckpoint(filepath='dense_model.keras', save_best_only=True, monitor='val_loss', mode='min', verbose=1)
mc = ModelCheckpoint('dense_model_jan_0.25_train_all_param_model.keras', monitor='val_loss', mode='min', save_best_only=True, verbose=1)
...
np.savetxt("dense_model_jan_0.25_train_all_param_x_predictions.csv", pred_rescaled, delimiter=",")
np.savetxt("dense_model_jan_0.25_train_all_param_y_original.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('dense_model_jan_0.25_train_all_param_training_loss.pdf', format='pdf')
plt.show()
...
plt.grid(True)
plt.savefig('dense_model_jan_0.25_train_all_param_true_vs_predicted.pdf', format='pdf')
plt.show()
...
plt.grid(True)
plt.savefig('dense_model_0.25_residuals_plot.pdf', format='pdf')
plt.show()