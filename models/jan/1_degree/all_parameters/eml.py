...
# ========== Save Predictions ==========
np.savetxt("ensemble_weighted_jan_1_predictions.csv", ensemble_pred, delimiter=",")
np.savetxt("quantile_q10_jan_1.csv", q10_inv, delimiter=",")
np.savetxt("quantile_q50_jan_1.csv", q50_inv, delimiter=",")
np.savetxt("quantile_q90_jan_1.csv", q90_inv, delimiter=",")
np.savetxt("y_test_actual_jan_1.csv", y_test_orig, delimiter=",")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("ensemble_weighted_jan_1_predictions.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("quantile_prediction_jan_1_bands_weighted.pdf")
plt.show()