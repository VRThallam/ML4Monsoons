...
# Load dataset
dataset = np.loadtxt('/content/jan_1_train_all_param.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# Save predictions
np.savetxt("jan_rf_jan_1_predictions.csv", predictions, delimiter=",")
np.savetxt("jan_rf_jan_1_y_test.csv", y_test_orig, delimiter=",")
...
plt.savefig("jan_rf_jan_1_prediction_vs_true.pdf")
plt.show()
...
plt.savefig("jan_rf_jan_1_feature_importance.pdf")
plt.show()