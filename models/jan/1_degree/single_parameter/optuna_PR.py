...
# =====================================================
df = pd.read_csv('/content/jan_1_train_all_param.csv')
...
np.savetxt("ensemble_optuna_jan_1_PR_predictions.csv", ensemble_preds_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_jan_1_PR_uncertainty.csv", ensemble_std_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_jan_1_PR_true_values.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('optuna_ensemble_jan_1_PR_val_loss_comparison.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_jan_1_PR_true_vs_predicted.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_jan_1_PR_residuals_plot.pdf')
plt.show()
