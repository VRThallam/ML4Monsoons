...
# ========== Save Predictions ==========
np.savetxt("ensemble_weighted_mar_025_predictions.csv", ensemble_pred, delimiter=",")
np.savetxt("quantile_q10_mar_025.csv", q10_inv, delimiter=",")
np.savetxt("quantile_q50_mar_025.csv", q50_inv, delimiter=",")
np.savetxt("quantile_q90_mar_025.csv", q90_inv, delimiter=",")
np.savetxt("y_test_actual_mar_025.csv", y_test_orig, delimiter=",")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("ensemble_weighted_mar_025_predictions.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("quantile_prediction_mar_025_bands_weighted.pdf")
plt.show()
