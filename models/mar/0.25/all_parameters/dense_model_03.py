...
dataset = loadtxt('/content/March_025_train_data_1982_2018.csv', delimiter=',', skiprows=1)
X = dataset[:, :36]
...
mc = ModelCheckpoint('dense_model_mar_1_train_all_param_model.keras', monitor='val_loss', mode='min', save_best_only=True, verbose=1)
...
np.savetxt("dense_model_mar_025_train_all_param_x_predictions.csv", pred_rescaled, delimiter=",")
np.savetxt("dense_model_mar_0255_train_all_param_y_original.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('dense_model_mar_025_train_all_param_training_loss.pdf', format='pdf')
plt.show()
...
plt.grid(True)
plt.savefig('dense_model_mar_025_train_all_param_true_vs_predicted.pdf', format='pdf')
plt.show()
...
plt.grid(True)
plt.savefig('dense_model_residuals_plot.pdf', format='pdf')
plt.show()
