...
plt.grid(True)
plt.tight_layout()
plt.savefig("knn_prediction_mar_025_improved.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("knn_mar_025_residuals_plot.pdf")
plt.show()

# Save predictions
np.savetxt("knn_improved_mar_025_x_test_predictions.csv", test_pred, delimiter=",")
np.savetxt("knn_improved_mar_025_y_test.csv", y_test_orig, delimiter=",")
