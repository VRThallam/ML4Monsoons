...
np.savetxt("ensemble_optuna_mar_025_predictions.csv", ensemble_preds_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_mar_025_uncertainty.csv", ensemble_std_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_mar_025_true_values.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('optuna_ensemble_mar_025_val_loss_comparison.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_mar_025_true_vs_predicted.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_mar_025_residuals_plot.pdf')
plt.show()
