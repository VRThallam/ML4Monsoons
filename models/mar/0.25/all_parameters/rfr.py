...
# Load dataset
dataset = np.loadtxt('C:\\March(0.25)train_data_1982_2018.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# Save predictions
np.savetxt("rf_mar_025_predictions.csv", predictions, delimiter=",")
np.savetxt("rf_mar_025_y_test.csv", y_test_orig, delimiter=",")
...
plt.savefig("rf_mar_025_prediction_vs_true.pdf")
plt.show()
...
plt.savefig("rf_mar_025_feature_importance.pdf")
plt.show()
