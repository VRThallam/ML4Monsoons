...
dataset = loadtxt('/content/March(1X1)train_data_1982_2018.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# ========== Save Predictions ==========
np.savetxt("predictions/stacked_ensemble_mar_1_predictions.csv", meta_pred, delimiter=",")
np.savetxt("predictions/y_test_actual_mar_1.csv", y_test_orig, delimiter=",")
np.savetxt("predictions/quantile_mar_1_q10.csv", q10_inv, delimiter=",")
np.savetxt("predictions/quantile_mar_1_q50.csv", q50_inv, delimiter=",")
np.savetxt("predictions/quantile_mar_1_q90.csv", q90_inv, delimiter=",")
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/stacked_ensemble_mar_1_predictions.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("predictions/quantile_mar_1_prediction_bands_stacked.pdf")
plt.show()
