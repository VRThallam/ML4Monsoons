...
np.savetxt("dense_model_mar_1_train_all_param_x_predictions.csv", pred_rescaled, delimiter=",")
np.savetxt("dense_model_mar_1_train_all_param_y_original.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('dense_model_mar_1_train_all_param_training_loss.pdf', format='pdf')
plt.show()
...
plt.grid(True)
plt.savefig('dense_model_mar_1_train_all_param_true_vs_predicted.pdf', format='pdf')
plt.show()
