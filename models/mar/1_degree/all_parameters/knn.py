...
X = dataset[:, 0:36]   # everything except IMD
...
plt.grid(True)
plt.tight_layout()
plt.savefig("knn_prediction_mar_1_improved.pdf")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("knn_mar_1_residuals_plot.pdf")
plt.show()

# Save predictions
np.savetxt("knn_improved_mar_1_x_test_predictions.csv", test_pred, delimiter=",")
np.savetxt("knn_improved_mar_1_y_test.csv", y_test_orig, delimiter=",")
