...
# Load dataset
dataset = np.loadtxt('/content/March(1X1)train_data_1982_2018.csv', delimiter=',', skiprows=1)
X = dataset[:, 0:36]
...
# Save predictions
np.savetxt("mar_rf_1_predictions.csv", predictions, delimiter=",")
np.savetxt("mar_rf_1_y_test.csv", y_test_orig, delimiter=",")
...
plt.savefig("mar_rf_1_prediction_vs_true.pdf")
plt.show()
...
plt.savefig("mar_rf_1_feature_importance.pdf")
plt.show()
