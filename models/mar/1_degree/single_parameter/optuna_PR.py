# Optuna ensemble (UPDATED with column-based loading)
...
# =====================================================
df = pd.read_csv('/content/MARCH_1X1_train_all_param.csv')

feature_cols = [
    "Latitude", "Longitude", "Month",
    "PR_M1","PR_M2","PR_M3","PR_M4","PR_M5",
    "PR_M6","PR_M7","PR_M8","PR_M9","PR_M10",
    "PR_M_Avg"
]
...
np.savetxt("ensemble_optuna_mar_1_PR_predictions.csv", ensemble_preds_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_mar_1_PR_uncertainty.csv", ensemble_std_rescaled, delimiter=",")
np.savetxt("ensemble_optuna_mar_1_PR_true_values.csv", y_test_rescaled, delimiter=",")
...
plt.legend()
plt.grid(True)
plt.savefig('optuna_ensemble_mar_1_PR_val_loss_comparison.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_mar_1_PR_true_vs_predicted.pdf')
plt.show()
...
plt.grid(True)
plt.savefig('optuna_ensemble_mar_1_PR_residuals_plot.pdf')
plt.show()
